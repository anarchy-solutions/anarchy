...
function load()
    ...
    do
        ...
        local Window = Library:CreateWindow({
            Title = "Anarchy :| V1.4 :| Preview Build (Only for DH)",
            Center = true,
            AutoShow = true,
            TabPadding = 8,
            MenuFadeTime = 0.8
        ...
        local Sections = {
            ...
            AntiAim = {
                ...
                FFlag = Tabs.AntiAim:AddRightGroupbox("FFlag"),
            },
            Misc = {
        ...
        do
            ...
            ThemeManager:SetFolder("Anarchy")
            SaveManager:SetFolder("Anarchy/Build")
